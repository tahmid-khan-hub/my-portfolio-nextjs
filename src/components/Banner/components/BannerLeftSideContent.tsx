...
export function BannerLeftSideContent() {
  ...
  return (
    <>
      ...
      <TypeAnimation
        ...
        className="text-3xl font-semibold bg-linear-to-r from-blue-700 via-blue-600 to-blue-300 bg-clip-text text-transparent inline-block mb-6"
      />
      ...
      <div className="flex gap-4 mb-6 w-full sm:w-auto justify-center md:justify-start">
        <AnimateOnView direction="up" delay={0.1} duration={0.6}>
          <button
            ...
            className="px-6 py-2.5 bg-linear-to-r from-blue-700 via-blue-600 to-blue-400 hover:from-blue-900 hover:to-blue-800 transition-transform duration-200 hover:scale-103 active:scale-95 rounded-xl font-medium"
          >
            Resume
          </button>
        </AnimateOnView>
        <AnimateOnView direction="up" delay={0.25} duration={0.6}>
          <a href="#projects">
            <button className="px-6 py-2.5 bg-linear-to-r border text-blue-500 hover:text-white hover:border-blue-700 hover:from-blue-800 hover:to-blue-700 transition-transform duration-200 hover:scale-103 active:scale-95 rounded-xl font-medium">
              My Work
            </button>
          </a>
        </AnimateOnView>
